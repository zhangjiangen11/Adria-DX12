...
#define res (FrameCB.displayResolution.xy/6.0)

static RWTexture2D<float4> outputTexture = ResourceDescriptorHeap[CRTFilterPassCB.outputIdx];
static Texture2D<float4> inputTexture = ResourceDescriptorHeap[CRTFilterPassCB.inputIdx];
