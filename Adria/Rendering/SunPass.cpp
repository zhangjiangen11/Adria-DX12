...
namespace adria
{
	...
	void SunPass::CreatePSO()
	{
		...
		gfx_pso_desc.input_layout.elements.push_back({"POSITION", 0, GfxFormat::R32G32B32_FLOAT, 0 });
		gfx_pso_desc.input_layout.elements.push_back({"TEX", 0, GfxFormat::R32G32_FLOAT, 0 });
